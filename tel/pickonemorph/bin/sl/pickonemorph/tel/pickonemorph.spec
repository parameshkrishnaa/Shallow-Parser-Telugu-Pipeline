...
<ENV>$setu=/home/setu/ilmtmodules/modules/pickonemorph/pickonemorph-1.1/setu
<ENV>$src=$setu/src
<ENV>$bin=$setu/bin
...
# Prunning 
1	pickonemorph		$setu/bin/sl/pickonemorph/pickonemorph.sh	dep=<START>	intype=1	lang=sh
