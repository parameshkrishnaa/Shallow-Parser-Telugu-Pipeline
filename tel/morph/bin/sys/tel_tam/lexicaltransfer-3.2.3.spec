...
<ENV>$setu=/home/teltamilmt/sampark
<ENV>$src=$setu/src
<ENV>$bin=$setu/bin
...
<OUTPUT_DIR>/home/teltamilmt/OUTPUT.tmp/modules
...
14	lexicaltransfer-3.2.3	$bin/sl_tl/lexicaltransfer/tel/lexicaltransfer_module_debug.sh	dep=<START>	intype=1	lang=sh
