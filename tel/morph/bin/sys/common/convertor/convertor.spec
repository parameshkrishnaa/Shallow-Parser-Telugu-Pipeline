...
# convertor
1	convertor		$setu/bin/sys/common/convertor/convertor_wx2utf_ssf_hin.sh	dep=<START>	intype=1	lang=sh
2	convertor		$setu/bin/sys/common/convertor/convertor_wx2utf_text_hin.sh	dep=<START>	intype=1	lang=sh
3	convertor		$setu/bin/sys/common/convertor/convertor_utf2wx_ssf_hin.sh	dep=<START>	intype=1	lang=sh
4	convertor		$setu/bin/sys/common/convertor/convertor_utf2wx_text_hin.sh	dep=<START>	intype=1	lang=sh
