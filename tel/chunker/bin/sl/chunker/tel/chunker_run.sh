perl $setu/bin/sl/chunker/tel/common/ssf2tnt_pos.pl $1 > chunkinput_pos.tnt
crf_test -m $setu/data_bin/sl/chunker/tel/200k_telugu_chunker_model chunkinput_pos.tnt > chunker_out.tnt
perl $setu/bin/sl/chunker/tel/common/convert_biotossf.pl < chunker_out.tnt 
...
rm chunkinput_pos.tnt chunker_out.tnt
